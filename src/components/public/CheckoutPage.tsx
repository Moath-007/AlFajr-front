...
export default function CheckoutPage({ onNavigate }: { onNavigate: (page: string) => void }) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-7 sm:px-6 sm:py-9 lg:px-8"><div className="mb-6"><p className="text-xs font-extrabold text-[#9C7537]">إتمام الطلب</p><h1 className="mt-1 text-2xl font-black text-[#162E21] sm:text-[1.75rem]">بيانات العميل والتوصيل</h1></div><div className="grid gap-5 lg:grid-cols-[1fr_330px] lg:items-start">
